...
pub struct NamespaceSubscription {
    ...
    /// Track filter from SUBSCRIBE_NAMESPACE (for top-N filtering)
...
impl SubscriberRegistry {
    ...
    pub fn register(
        ...
        self.register_with_publisher_id(prefix, None, None)
    }
...
mod tests {
    ...
    async fn test_self_exclusion_with_filter() {
        ...
        let (viewer_id, mut viewer_rx, _) = registry.register_with_publisher_id(room_ns.clone(), track_filter.clone(), None);
